// Form for capturing details of a user: firstname, lastname, email, username,
password // Form info is validated and then emitted in an object to the parent
component
<template>
  <b-form>
    <b-form-group
      ...
      :state="firstNameValidator.state"
      :invalid-feedback="firstNameValidator.invalidFeedback"
    ...
    <b-form-group
      ...
      label="Last Name"
      label-for="lastName2"
      :state="lastNameValidator.state"
      :invalid-feedback="lastNameValidator.invalidFeedback"
    ...
    <b-form-group
      id="emailGroup2"
      label="Email"
      label-for="emailName2"
      :state="emailValidator.state"
      :invalid-feedback="emailValidator.invalidFeedback"
    ...
    <b-form-group
      ...
      :invalid-feedback="userNameValidator.invalidFeedback"
    ...
    <b-form-group
      ...
      :invalid-feedback="passwordValidator.invalidFeedback"
    ...
    <b-button :to="{ name: 'homepage' }" type="button" variant="secondary"
      >Cancel</b-button
    >
    <b-button
  ...
  computed: {
    allFieldsValid() {
      return (
        ...
        this.firstNameValidator.state &&
        this.lastNameValidator.state &&
