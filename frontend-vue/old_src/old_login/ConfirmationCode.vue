// component for entering the confirmation code // // Props: // email - the
email address of the user that must enter the confirmation code // emits: //
        ...
        .then((data) => {
          ...
          if (data === "SUCCESS") {
            ...
            return Promise.reject(
              new Error("unknown response from cognito " + data)
            );
          }
        })
        .catch((err) => {
