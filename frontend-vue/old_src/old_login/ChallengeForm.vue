// Form for capturing Cognito Challenge information. Specifically a new password
plus any other user information that // wasn't captured when a user signed up //
Form info is validated and then emitted in an object to the parent component //
Input Props: none // Emitted Events and Values: // 'validated', newPassword -
this event will be emitted when the form fields are valid and the // 'cancel' -
if the user cancels the form // submit button of the form is clicked. This event
will contain the users new password
<template>
  <b-form>
    <b-form-group
      id="passwordGroup1"
    ...
    <b-form-group
      ...
      :state="
        $v.form.preferredUsername.$dirty && !$v.form.preferredUsername.$invalid
      "
    ...
    <b-button
      ...
      >Submit</b-button
    >
    <b-button block size="lg" type="submit" variant="danger" @click="emitCancel"
      >Cancel</b-button
    >
  </b-form>
</template>
