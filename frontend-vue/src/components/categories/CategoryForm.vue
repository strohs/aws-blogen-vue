// A form component that validates the fields that make up a category and then
emits the validated fields back // to the parent component //
<template>
  <!-- v-on:submit.prevent added to prevent form from erroneously submitting data when enter key is pressed -->
  <b-form @submit.prevent>
    <b-form-group
      id="categoryNameGroup3"
      label="Category Name"
      label-for="categoryName3"
