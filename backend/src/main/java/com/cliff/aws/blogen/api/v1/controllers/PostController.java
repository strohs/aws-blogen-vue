...
import com.cliff.aws.blogen.api.v1.validators.PostRequestDtoValidator;
...
/**
 * REST Controller for working with {@link com.cliff.aws.blogen.domain.Blogen} Post
 *
 * @author Cliff
 */
@Api
...
public class PostController {
    ...
    @PostMapping( "/{id}")
    @ResponseStatus( HttpStatus.CREATED )
    public PostDTO createChildPost( @PathVariable("id") String parentId, @Valid @RequestBody PostRequestDTO postRequestDTO ) {
    ...
    @PutMapping( "/{id}" )
    @ResponseStatus( HttpStatus.OK )
    public PostDTO updatePost( @PathVariable("id") String id, @Valid @RequestBody PostRequestDTO postRequestDTO ) {
        log.debug( "updatePost id=" + id + " postDTO:" + postRequestDTO );
    ...
    @PatchMapping( "/{id}" )
    @ResponseStatus( HttpStatus.OK )
    public PostDTO patchPost( @PathVariable( "id" ) String id, @RequestBody PostRequestDTO postRequestDTO ) {
