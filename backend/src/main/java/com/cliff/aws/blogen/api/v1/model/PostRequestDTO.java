...
/**
 * A Data Transfer Object that encapsulates a request from a client to create a new post.
 *
 * Author: Cliff
 */
@Data
...
public class PostRequestDTO {
    ...
    @ApiModelProperty( value = "category name that this post belongs to", required = true, example = "Technology")
