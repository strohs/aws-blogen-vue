...
public class Bootstrapper implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public Bootstrapper( BlogenRepository blogenRepository,
...
//                UUID.randomUUID().toString(), "admin", "Carl", "Sagan",
//                "admin@blogen.org", "adminpassword", yesterday,
//                "avatar2.jpg", true, "ADMIN","USER");
//        admin.setPassword( encryptionService.encrypt("adminpassword"));
//
//        // this user will be assigned a specific UserId so that we can easily run tests on it
//        String johnId = "1234-ABCD";
//        Blogen john = buildBlogenUser(
//                johnId, "johndoe", "John","Doe",
//                "jdoe@gmail.com","password", yesterday,
//                "avatar3.jpg", true, "USER");
//        john.setPassword( encryptionService.encrypt("password") );
//
//        Blogen william = buildBlogenUser(
//                UUID.randomUUID().toString(), "scotsman", "William","Wallace",
//                "scotsman@yahoo.com","password", yesterday,
//                "avatar4.jpg", true, "USER");
//        william.setPassword( encryptionService.encrypt("password") );
//
//        Blogen maggie = buildBlogenUser(
//                UUID.randomUUID().toString(), "mcgill", "Maggie","McGill",
//                "gilly@att.com","password", yesterday,
//                "avatar1.jpg", true, "USER");
//        maggie.setPassword( encryptionService.encrypt("password") );
//
//        Blogen elizabeth = buildBlogenUser(
//                UUID.randomUUID().toString(), "lizreed", "Elizabeth","Reed",
//                "lizz@gmail.com","password", yesterday,
//                "avatar5.jpg", true, "USER");
//        elizabeth.setPassword( encryptionService.encrypt("password") );
//
...
//                "Health & Fitness", "Started lifting today","Trying to burn off these holiday calories. I hear resistence training is better than running",
