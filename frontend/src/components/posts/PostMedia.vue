<template>
  <!-- This component renders a single post using a Bootstrap Media Object -->
  ...
  <b-media>
    ...
    <h6>Posted By:
      <small>
        <b-link :to="{ name: 'users', params: { id: user.id, userName: user.userName, avatarImage: user.avatarUrl } }">{{user.userName}}</b-link>
      </small>
      in
